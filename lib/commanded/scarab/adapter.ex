defmodule Commanded.Khepri.Adapter do
  @moduledoc """
  Adapter to use [Khepri](https://rabbitmq.github.io/khepri/) with Commanded.
  ...
  alias Commanded.Khepri.Config
  alias Commanded.Khepri.Mapper
  alias Commanded.Khepri.Subscription
  alias Commanded.Khepri.SubscriptionsSupervisor
